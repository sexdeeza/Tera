...
public class MapleSquad {
    ...
    public static enum MapleSquadType {
        bossbalrog(1), zak(1), chaoszak(2), horntail(1), chaosht(2), pinkbean(2), nmm_squad(2), vergamot(2), dunas(2), nibergen_squad(2), dunas2(2), core_blaze(2), aufheben(2), cwkpq(10), tokyo_2095(2), vonleon(1), scartar(1), cygnus(2);
